    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo_profile', models.ImageField(default='profile/icon_profile.png', upload_to='profile_photos')),
                ...
                ('role', models.CharField(choices=[('ETUDIANT', 'Etudiant'), ('ENSEIGNANT', 'Enseignant'), ('RESPONSABLE_SCOLARITE', 'Responsable scolarité'), ('ADMINISTRATEUR', 'Administrateur'), ('COMPTABLE', 'Comptable'), ('null', 'null')], default='null', max_length=30)),
